    ...
    return (
        <div className="sign_container">
            ...
            <form className="sign_form" onSubmit={e => e.preventDefault()}>
                <input autoSave="off" className="sign_input" type="text" placeholder="نام کاربری" onChange={e => set_user_email(e.target.value)} />
                <input autoSave="off" className="sign_input" type="password" placeholder="رمز عبور" onChange={e => set_user_password(e.target.value)} />
